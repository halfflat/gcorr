...
std::vector<float2> run_unpack2bit_2chan_fast(const std::vector<int8_t>& packed, int packed_stride, int packed_offset, const std::vector<int32_t> shifts, int nant, int nfft, int fftwidth);
